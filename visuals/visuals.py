...
def matplotlibdefaults(palette="medium", useTex=False):
    ...
    if palette == "pastel":
        ...
        _colors = [
            {"color": "#ffd700", "name": "gold", "textColor": "black"},
            {"color": "#ffb14e", "name": "orange", "textColor": "black"},
            {"color": "#fa8775", "name": "light orange", "textColor": "black"},
            {"color": "#ea5f94", "name": "pink", "textColor": "black"},
            {"color": "#cd34b5", "name": "magenta", "textColor": "white"},
            {"color": "#9d02d7", "name": "magenta", "textColor": "white"},
            {"color": "#0000ff", "name": "indigo", "textColor": "white"},
        ]
        cs = [item.get("color") for item in _colors]
    else:
    ...
    rcParams["axes.prop_cycle"] = cycler(color=cs)
    ...
    rcParams["grid.alpha"] = 0.5  # transparency, between 0.0 and 1.0
...
def setspines():
    ...
    for i in matplotlib.pylab.get_fignums():
        for j in matplotlib.pylab.figure(i).get_axes():
            ...
            j.tick_params(
                axis="both", top="off", right="off", which="both", colors="#8C8C8C"
            )
...
def setspines4():
    ...
    for i in matplotlib.pylab.get_fignums():
        for j in matplotlib.pylab.figure(i).get_axes():
            ...
            # j.spines['right'].set_color('none')
            j.tick_params(
                axis="both", top="on", right="on", which="both", colors="#8C8C8C"
            )
            # j.spines['left'].set_position(('outward',10))
            # j.spines['bottom'].set_position(('outward',10))
            # j.spines['left'].set_position(('axes', -0.05))
...
def setspines2():
    ...
    for i in matplotlib.pylab.get_fignums():
        for j in matplotlib.pylab.figure(i).get_axes():
            ...
            # j.spines['right'].set_color('none')
            j.tick_params(
                axis="both", top="off", right="on", which="both", colors="#8C8C8C"
            )
            # j.spines['left'].set_position(('outward',10))
            # j.spines['bottom'].set_position(('outward',10))
            # j.spines['right'].set_position(('outward',10))
            # j.spines['top'].set_position(('outward',10))
    #             j.spines['left'].set_position(('axes', -0.05))
    # j.spines['bottom'].set_position(('axes', -0.05))
    return 0
...
def setspines0():
    ...
    for i in matplotlib.pylab.get_fignums():
        for j in matplotlib.pylab.figure(i).get_axes():
            j.spines["top"].set_color("none")
            #             j.spines['bottom'].set_color('none')
            j.spines["right"].set_color("none")
            j.spines["left"].set_color("none")
            j.tick_params(
                axis="both", top="off", right="off", which="both", colors="#8C8C8C"
            )
            # j.spines['left'].set_position(('outward',10))
...
matplotlibdefaults(useTex=True)
